...
const GooeyNav = ({
  ...
  useEffect(() => {
    ...
    const activeLi = navRef.current.querySelectorAll('li')[resolvedActiveIndex] as HTMLElement;
    if (activeLi) {
    ...
    const resizeObserver = new ResizeObserver(() => {
      const currentActiveLi = navRef.current?.querySelectorAll('li')[resolvedActiveIndex] as HTMLElement;
      if (currentActiveLi) {
      ...
      <nav>
        <ul ref={navRef}>
          {items.map((item, index) => (
            <li key={index} className={resolvedActiveIndex === index ? 'active' : ''}>
